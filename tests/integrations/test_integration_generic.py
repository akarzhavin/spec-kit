...
class TestGenericIntegration:
    ...
    def test_complete_file_inventory_sh(self, tmp_path):
        ...
        expected = sorted([
            ...
            ".myagent/commands/speckit.done.md",
            ".myagent/commands/speckit.implement.md",
            ".myagent/commands/speckit.plan.md",
            ".myagent/commands/speckit.plan-final.md",
            ".myagent/commands/speckit.plan-localtest.md",
            ".myagent/commands/speckit.plan-release.md",
            ".myagent/commands/speckit.plan-review.md",
